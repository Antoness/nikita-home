        ...
        <Container>
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <button className="btn btn-danger btn-lg rounded-1 me-2 mb-xs-0 mb-2 animate__animated animate__fadeInDown animate__delay-1s"  onClick={openRegisterLink}>
                Register
              </button>
              <button className="btn btn-outline-danger btn-lg rounded-1 mb-xs-0 mb-2 animate__animated animate__fadeInDown animate__delay-1s" onClick={openStartGeneratorLink}>
                Start Generator
              </button>
            </Col>
            <Col lg="6" className="pt-lg-0 pt-5">
              <img src={HeroImage} alt="hero-img" className="animate__animated animate__fadeInDown" />
            </Col>
          </Row>
        </Container>
      </header>
      <div className="kelas w-100 min-vh-100">
        <Container>
          ...
          <div className="d-block">
            {/* start here */}
            <Row className="row-cols-1 row-cols-md-2" data-aos="fade-up" data-aos-duration="1000">
              <div className="col-md-6 why-card-control mb-4" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
                ...
                <div className="why-card-hover text-center">
                  ...
                  <a href="" className="home-page-hover-effect-btn">
                    Check Out Our Integration Platforms
                  </a>
                </div>
              </div>
              <div className="col-md-6 why-card-control mb-4" data-aos="zoom-in-left" data-aos-duration="1000" data-aos-delay="400">
                <div className="card-block text-center why-card">
              ...
              <div className="col-md-6 why-card-control mb-4" data-aos="flip-up" data-aos-duration="1000" data-aos-delay="500">
                <div className="card-block text-center why-card">
                ...
                <div className="why-card-hover text-center">
                  ...
                  <p>
                  Nikita Generator has prepared dozens of components and functions. Users only use it as needed
                  </p>
                  <a href="" className="home-page-hover-effect-btn">
                    Check Out Our Integration Platforms
                  </a>
              ...
              <div className="col-md-6 why-card-control mb-4" data-aos="flip-down" data-aos-duration="1000" data-aos-delay="600">
                <div className="card-block text-center why-card">
                ...
                <div className="why-card-hover text-center">
                  ...
                  <p>
                  Nikita generator can easily adapt the business framework and work on it easily
                  </p>
                  <a href="" className="home-page-hover-effect-btn">
                    Check Out Our Integration Platforms
                  </a>
